...
export const UserDrawer = () => {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <AppBar id="33m5WuJe" position="fixed" open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
      ...
      >
        ...
        <List>
          ...
          <ListItem key={"Premade Decks"} disablePadding>
            <ListItemButton component={Link} to="/premade">
              <ListItemIcon>
                <DnsIcon />
              </ListItemIcon>
              <ListItemText primary={"Premade Decks"} />
            </ListItemButton>
          </ListItem>
        </List>
        <Divider />
